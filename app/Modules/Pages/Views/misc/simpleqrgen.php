...
<body class="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100">
    ...
    <div class="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden border border-gray-100">
        ...
        <div class="bg-indigo-600 p-6 text-center">
            ...
            <p class="text-indigo-200 text-sm mt-1">Buat kode QR kustom Anda secara instan</p>
        </div>

        <!-- Tabs Navigation -->
        <div class="flex border-b border-gray-200">
            <button onclick="switchTab('text')" id="tab-btn-text" class="flex-1 py-3 px-4 text-center text-sm font-semibold text-indigo-600 border-b-2 border-indigo-600 focus:outline-none transition-colors">
                Teks / URL
            </button>
            <button onclick="switchTab('wa')" id="tab-btn-wa" class="flex-1 py-3 px-4 text-center text-sm font-semibold text-gray-500 hover:text-indigo-600 focus:outline-none transition-colors border-b-2 border-transparent">
                WhatsApp
            </button>
        </div>
        ...
        <div class="p-6 space-y-6">
            ...
            <div id="content-text" class="block">
                <label for="text-input" class="block text-sm font-medium text-gray-700 mb-2">Teks atau URL</label>
            ...
            <div id="content-wa" class="hidden space-y-4">
                <div>
                    <label for="wa-number" class="block text-sm font-medium text-gray-700 mb-2">Nomor WhatsApp</label>
                    <input type="tel" id="wa-number"
                        class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition duration-200"
                        placeholder="Contoh: 628123456789"
                        autocomplete="off">
                    <p class="text-xs text-gray-500 mt-1">Gunakan kode negara (misal: 62 untuk Indonesia) tanpa tanda +.</p>
                </div>
                <div>
                    <label for="wa-message" class="block text-sm font-medium text-gray-700 mb-2">Pesan Otomatis</label>
                    <textarea id="wa-message" rows="3"
                        class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition duration-200"
                        placeholder="Halo, saya ingin bertanya tentang produk Anda..."></textarea>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label for="color-dark" class="block text-sm font-medium text-gray-700 mb-2">Warna Kode</label>
                    <div class="flex items-center space-x-2 border border-gray-300 rounded-lg p-2 cursor-pointer hover:bg-gray-50 transition">
                        <input type="color" id="color-dark" value="#000000" class="w-8 h-8 rounded cursor-pointer border-none bg-transparent">
                        <span class="text-sm text-gray-500">Pilih</span>
                    </div>
                </div>
                <div>
                    <label for="color-light" class="block text-sm font-medium text-gray-700 mb-2">Latar Belakang</label>
                    <div class="flex items-center space-x-2 border border-gray-300 rounded-lg p-2 cursor-pointer hover:bg-gray-50 transition">
                        <input type="color" id="color-light" value="#ffffff" class="w-8 h-8 rounded cursor-pointer border-none bg-transparent">
                        <span class="text-sm text-gray-500">Pilih</span>
                    </div>
                </div>
            </div>
            ...
            <!-- Output Area -->
            <div id="output-container" class="hidden flex-col items-center justify-center space-y-4 p-6 bg-gray-50 rounded-xl border border-gray-200 dashed">
    ...
    <!-- Notification Toast -->
    <div id="toast" class="fixed bottom-5 right-5 bg-gray-800 text-white px-6 py-3 rounded-lg shadow-lg transform translate-y-20 opacity-0 transition-all duration-300 pointer-events-none">
        Pesan notifikasi
    </div>
